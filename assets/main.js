  ...
  var require_react_development = __commonJS((exports) => {
    ...
    if (true) {
      (function() {
        ...
        function getComponentName2(type) {
          if (type == null) {
            return null;
          }
          {
          ...
          if (typeof type === "object") {
            switch (type.$$typeof) {
              ...
              case REACT_MEMO_TYPE:
                return getComponentName2(type.type);
              case REACT_BLOCK_TYPE:
                return getComponentName2(type.render);
              case REACT_LAZY_TYPE: {
                var thenable = type;
                var resolvedThenable = refineResolvedLazyComponent(thenable);
                if (resolvedThenable) {
                  return getComponentName2(resolvedThenable);
                }
                break;
              }
            }
        ...
        }
        {
          ...
          ReactDebugCurrentFrame.getStackAddendum = function() {
            ...
            if (currentlyValidatingElement) {
              var name = getComponentName2(currentlyValidatingElement.type);
              var owner = currentlyValidatingElement._owner;
              stack += describeComponentFrame(name, currentlyValidatingElement._source, owner && getComponentName2(owner.type));
            }
        ...
        function warnIfStringRefCannotBeAutoConverted(config) {
          {
            if (typeof config.ref === "string" && ReactCurrentOwner.current && config.__self && ReactCurrentOwner.current.stateNode !== config.__self) {
              var componentName = getComponentName2(ReactCurrentOwner.current.type);
              if (!didWarnAboutStringRefs[componentName]) {
                error('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://fb.me/react-strict-mode-string-ref', getComponentName2(ReactCurrentOwner.current.type), config.ref);
        ...
        function getDeclarationErrorAddendum() {
          if (ReactCurrentOwner.current) {
            var name = getComponentName2(ReactCurrentOwner.current.type);
            if (name) {
        ...
        function validateExplicitKey(element, parentType) {
          ...
          if (element && element._owner && element._owner !== ReactCurrentOwner.current) {
            childOwner = " It was passed a child from " + getComponentName2(element._owner.type) + ".";
          }
        ...
        function validatePropTypes(element) {
          {
            ...
            var name = getComponentName2(type);
            var propTypes;
            if (typeof type === "function") {
        ...
        function createElementWithValidation(type, props, children) {
          ...
          if (!validType) {
            ...
            if (type === null) {
              ...
              typeString = "<" + (getComponentName2(type.type) || "Unknown") + " />";
    ...
    if (true) {
      (function() {
        ...
        function describeFiber(fiber) {
          switch (fiber.tag) {
            ...
            default:
              ...
              var name = getComponentName2(fiber.type);
              var ownerName = null;
              if (owner) {
                ownerName = getComponentName2(owner.type);
              }
        ...
        function getCurrentFiberOwnerNameInDevOrNull() {
          {
            ...
            if (owner !== null && typeof owner !== "undefined") {
              return getComponentName2(owner.type);
            }
          }
          return null;
        }
        ...
        function isMounted(component) {
          {
            ...
            if (owner !== null && owner.tag === ClassComponent) {
              ...
              if (!instance._warnedAboutRefsInRender) {
                error("%s is accessing isMounted inside its render() function. render() should be a pure function of props and state. It should never access something that requires stale data from the previous render, such as refs. Move this logic to componentDidMount and componentDidUpdate instead.", getComponentName2(ownerFiber.type) || "A component");
              }
        ...
        var beginFiberMark = function(fiber, phase) {
          var componentName = getComponentName2(fiber.type) || "Unknown";
        ...
        function stopWorkLoopTimer(interruptedBy2, didCompleteRoot) {
          {
            ...
            if (interruptedBy2 !== null) {
              if (interruptedBy2.tag === HostRoot) {
                ...
                var componentName = getComponentName2(interruptedBy2.type) || "Unknown";
        ...
        function getMaskedContext(workInProgress2, unmaskedContext) {
          {
            ...
            {
              var name = getComponentName2(type) || "Unknown";
        ...
        function processChildContext(fiber, type, parentContext) {
          {
            ...
            if (typeof instance.getChildContext !== "function") {
              {
                var componentName = getComponentName2(type) || "Unknown";
            ...
            for (var contextKey in childContext) {
              if (!(contextKey in childContextTypes)) {
                {
                  throw Error((getComponentName2(type) || "Unknown") + '.getChildContext(): key "' + contextKey + '" is not defined in childContextTypes.');
                }
              }
            }
            {
          ...
          ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function() {
            ...
            if (pendingComponentWillMountWarnings.length > 0) {
              pendingComponentWillMountWarnings.forEach(function(fiber) {
                componentWillMountUniqueNames.add(getComponentName2(fiber.type) || "Component");
            ...
            if (pendingUNSAFE_ComponentWillMountWarnings.length > 0) {
              pendingUNSAFE_ComponentWillMountWarnings.forEach(function(fiber) {
                UNSAFE_componentWillMountUniqueNames.add(getComponentName2(fiber.type) || "Component");
                didWarnAboutUnsafeLifecycles.add(fiber.type);
              });
            ...
            if (pendingComponentWillReceivePropsWarnings.length > 0) {
              pendingComponentWillReceivePropsWarnings.forEach(function(fiber) {
                componentWillReceivePropsUniqueNames.add(getComponentName2(fiber.type) || "Component");
                didWarnAboutUnsafeLifecycles.add(fiber.type);
              });
            ...
            if (pendingUNSAFE_ComponentWillReceivePropsWarnings.length > 0) {
              pendingUNSAFE_ComponentWillReceivePropsWarnings.forEach(function(fiber) {
                UNSAFE_componentWillReceivePropsUniqueNames.add(getComponentName2(fiber.type) || "Component");
                didWarnAboutUnsafeLifecycles.add(fiber.type);
              });
            ...
            if (pendingComponentWillUpdateWarnings.length > 0) {
              pendingComponentWillUpdateWarnings.forEach(function(fiber) {
                componentWillUpdateUniqueNames.add(getComponentName2(fiber.type) || "Component");
                didWarnAboutUnsafeLifecycles.add(fiber.type);
              });
            ...
            if (pendingUNSAFE_ComponentWillUpdateWarnings.length > 0) {
              pendingUNSAFE_ComponentWillUpdateWarnings.forEach(function(fiber) {
                UNSAFE_componentWillUpdateUniqueNames.add(getComponentName2(fiber.type) || "Component");
                didWarnAboutUnsafeLifecycles.add(fiber.type);
              });
          ...
          ReactStrictModeWarnings.flushLegacyContextWarning = function() {
            pendingLegacyContextWarning.forEach(function(fiberArray, strictRoot) {
              ...
              fiberArray.forEach(function(fiber) {
                uniqueNames.add(getComponentName2(fiber.type) || "Component");
        ...
        var didWarnAboutInvalidateContextType;
        {
          ...
          warnOnUndefinedDerivedState = function(type, partialState) {
            if (partialState === void 0) {
              var componentName = getComponentName2(type) || "Component";
          ...
          if (typeof instance.shouldComponentUpdate === "function") {
            ...
            stopPhaseTimer();
            {
              if (shouldUpdate === void 0) {
                error("%s.shouldComponentUpdate(): Returned undefined instead of a boolean value. Make sure to return true or false.", getComponentName2(ctor) || "Component");
              }
            }
            return shouldUpdate;
          }
        ...
        function checkClassInstance(workInProgress2, ctor, newProps) {
          var instance = workInProgress2.stateNode;
          {
            var name = getComponentName2(ctor) || "Component";
            ...
            if (ctor.prototype && ctor.prototype.isPureReactComponent && typeof instance.shouldComponentUpdate !== "undefined") {
              error("%s has a method called shouldComponentUpdate(). shouldComponentUpdate should not be used when extending React.PureComponent. Please extend React.Component if shouldComponentUpdate is used.", getComponentName2(ctor) || "A pure component");
            }
            ...
            if (typeof instance.getSnapshotBeforeUpdate === "function" && typeof instance.componentDidUpdate !== "function" && !didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate.has(ctor)) {
              ...
              error("%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). This component defines getSnapshotBeforeUpdate() only.", getComponentName2(ctor));
            }
        ...
        function constructClassInstance(workInProgress2, ctor, props) {
          ...
          var contextType = ctor.contextType;
          {
            if ("contextType" in ctor) {
              ...
              if (!isValid && !didWarnAboutInvalidateContextType.has(ctor)) {
                ...
                error("%s defines an invalid contextType. contextType should point to the Context object returned by React.createContext().%s", getComponentName2(ctor) || "Component", addendum);
              }
            }
          }
          ...
          adoptClassInstance(workInProgress2, instance);
          {
            if (typeof ctor.getDerivedStateFromProps === "function" && state === null) {
              var componentName = getComponentName2(ctor) || "Component";
            ...
            if (typeof ctor.getDerivedStateFromProps === "function" || typeof instance.getSnapshotBeforeUpdate === "function") {
              ...
              if (foundWillMountName !== null || foundWillReceivePropsName !== null || foundWillUpdateName !== null) {
                var _componentName = getComponentName2(ctor) || "Component";
        ...
        function callComponentWillMount(workInProgress2, instance) {
          ...
          if (oldState !== instance.state) {
            {
              error("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", getComponentName2(workInProgress2.type) || "Component");
            }
        ...
        function callComponentWillReceiveProps(workInProgress2, instance, newProps, nextContext) {
          ...
          if (instance.state !== oldState) {
            {
              var componentName = getComponentName2(workInProgress2.type) || "Component";
          ...
          if (mixedRef !== null && typeof mixedRef !== "function" && typeof mixedRef !== "object") {
            {
              if ((returnFiber.mode & StrictMode || warnAboutStringRefs) && !(element._owner && element._self && element._owner.stateNode !== element._self)) {
                var componentName = getComponentName2(returnFiber.type) || "Component";
                if (!didWarnAboutStringRefs[componentName]) {
                  {
        ...
        function warnOnHookMismatchInDev(currentHookName) {
          {
            var componentName = getComponentName2(currentlyRenderingFiber$1.type);
        ...
        function updateForwardRef(current2, workInProgress2, Component, nextProps, renderExpirationTime2) {
          {
            if (workInProgress2.type !== workInProgress2.elementType) {
              ...
              if (innerPropTypes) {
                checkPropTypes(innerPropTypes, nextProps, "prop", getComponentName2(Component), getCurrentFiberStackInDev);
              }
            }
          }
        ...
        function updateMemoComponent(current2, workInProgress2, Component, nextProps, updateExpirationTime, renderExpirationTime2) {
          if (current2 === null) {
            ...
            }
            {
              ...
              if (innerPropTypes) {
                checkPropTypes(innerPropTypes, nextProps, "prop", getComponentName2(type), getCurrentFiberStackInDev);
              }
            }
          ...
          }
          {
            ...
            if (_innerPropTypes) {
              checkPropTypes(_innerPropTypes, nextProps, "prop", getComponentName2(_type), getCurrentFiberStackInDev);
            }
          }
        ...
        function updateSimpleMemoComponent(current2, workInProgress2, Component, nextProps, updateExpirationTime, renderExpirationTime2) {
          {
            if (workInProgress2.type !== workInProgress2.elementType) {
              ...
              if (outerPropTypes) {
                checkPropTypes(outerPropTypes, nextProps, "prop", getComponentName2(outerMemoType), getCurrentFiberStackInDev);
              }
            }
          }
          if (current2 !== null) {
          ...
          var nextUnitOfWork = finishClassComponent(current2, workInProgress2, Component, shouldUpdate, hasContext, renderExpirationTime2);
          {
            ...
            if (inst.props !== nextProps) {
              if (!didWarnAboutReassigningProps) {
                error("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", getComponentName2(workInProgress2.type) || "a component");
              }
            ...
            case MemoComponent: {
              {
                if (workInProgress2.type !== workInProgress2.elementType) {
                  ...
                  if (outerPropTypes) {
                    checkPropTypes(outerPropTypes, resolvedProps, "prop", getComponentName2(Component), getCurrentFiberStackInDev);
                  }
                }
              }
        ...
        function mountIndeterminateComponent(_current, workInProgress2, Component, renderExpirationTime2) {
          ...
          var value;
          {
            if (Component.prototype && typeof Component.prototype.render === "function") {
              var componentName = getComponentName2(Component) || "Unknown";
          ...
          if (typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === void 0) {
            {
              var _componentName = getComponentName2(Component) || "Unknown";
        ...
        function validateFunctionComponentInDev(workInProgress2, Component) {
          {
            ...
            if (typeof Component.getDerivedStateFromProps === "function") {
              var _componentName2 = getComponentName2(Component) || "Unknown";
            ...
            if (typeof Component.contextType === "object" && Component.contextType !== null) {
              var _componentName3 = getComponentName2(Component) || "Unknown";
            ...
            case MemoComponent: {
              ...
              var _resolvedProps3 = resolveDefaultProps(_type2, _unresolvedProps3);
              {
                if (workInProgress2.type !== workInProgress2.elementType) {
                  ...
                  if (outerPropTypes) {
                    checkPropTypes(outerPropTypes, _resolvedProps3, "prop", getComponentName2(_type2), getCurrentFiberStackInDev);
                  }
                }
              }
        ...
        function logError(boundary, errorInfo) {
          ...
          var capturedError = {
            componentName: source !== null ? getComponentName2(source.type) : null,
          ...
          if (boundary !== null && boundary.tag === ClassComponent) {
            ...
            capturedError.errorBoundaryName = getComponentName2(boundary.type);
                ...
                if (current2 !== null) {
                  ...
                  var instance = finishedWork.stateNode;
                  {
                    if (finishedWork.type === finishedWork.elementType && !didWarnAboutReassigningProps) {
                      if (instance.props !== finishedWork.memoizedProps) {
                        error("Expected %s props to match memoized props before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                      }
                      if (instance.state !== finishedWork.memoizedState) {
                        error("Expected %s state to match memoized state before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                      }
                    }
                  }
                  var snapshot = instance.getSnapshotBeforeUpdate(finishedWork.elementType === finishedWork.type ? prevProps : resolveDefaultProps(finishedWork.type, prevProps), prevState);
                  {
                    ...
                    if (snapshot === void 0 && !didWarnSet.has(finishedWork.type)) {
                      ...
                      error("%s.getSnapshotBeforeUpdate(): A snapshot value (or null) must be returned. You have returned undefined.", getComponentName2(finishedWork.type));
                    }
                  }
              ...
              if (finishedWork.effectTag & Update) {
                if (current2 === null) {
                  startPhaseTimer(finishedWork, "componentDidMount");
                  {
                    if (finishedWork.type === finishedWork.elementType && !didWarnAboutReassigningProps) {
                      if (instance.props !== finishedWork.memoizedProps) {
                        error("Expected %s props to match memoized props before componentDidMount. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                      }
                      if (instance.state !== finishedWork.memoizedState) {
                        error("Expected %s state to match memoized state before componentDidMount. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                      }
                    }
                  }
                  ...
                  startPhaseTimer(finishedWork, "componentDidUpdate");
                  {
                    if (finishedWork.type === finishedWork.elementType && !didWarnAboutReassigningProps) {
                      if (instance.props !== finishedWork.memoizedProps) {
                        error("Expected %s props to match memoized props before componentDidUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                      }
                      if (instance.state !== finishedWork.memoizedState) {
                        error("Expected %s state to match memoized state before componentDidUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                      }
                    }
                  }
              ...
              if (updateQueue !== null) {
                {
                  if (finishedWork.type === finishedWork.elementType && !didWarnAboutReassigningProps) {
                    if (instance.props !== finishedWork.memoizedProps) {
                      error("Expected %s props to match memoized props before processing the update queue. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                    }
                    if (instance.state !== finishedWork.memoizedState) {
                      error("Expected %s state to match memoized state before processing the update queue. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentName2(finishedWork.type) || "instance");
                    }
                  }
                }
            ...
            if (typeof ref === "function") {
            ...
            } else {
              {
                if (!ref.hasOwnProperty("current")) {
                  error("Unexpected ref object provided for %s. Use either a ref-setter function or React.createRef().%s", getComponentName2(finishedWork.type), getStackByFiberInDevAndProd(finishedWork));
                }
              }
              ...
              });
              {
                if (typeof getDerivedStateFromError !== "function") {
                  if (fiber.expirationTime !== Sync) {
                    error("%s: Error boundaries should implement getDerivedStateFromError(). In that method, return a state update to display an error message or fallback UI.", getComponentName2(fiber.type) || "Unknown");
                  }
                }
              }
            };
        ...
        function throwException(root2, returnFiber, sourceFiber, value, renderExpirationTime2) {
          ...
          if (value !== null && typeof value === "object" && typeof value.then === "function") {
            ...
            value = new Error((getComponentName2(sourceFiber.type) || "A React component") + " suspended while rendering, but no fallback UI was specified.\n\nAdd a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display." + getStackByFiberInDevAndProd(sourceFiber));
          }
          renderDidError();
        ...
        function warnAboutUpdateOnUnmountedFiberInDEV(fiber) {
          {
            ...
            var componentName = getComponentName2(fiber.type) || "ReactComponent";
        ...
        function warnAboutRenderPhaseUpdatesInDEV(fiber) {
          {
            if (isRendering && (executionContext & RenderContext) !== NoContext) {
              switch (fiber.tag) {
                ...
                case ForwardRef:
                case SimpleMemoComponent: {
                  var renderingComponentName = workInProgress && getComponentName2(workInProgress.type) || "Unknown";
                  var dedupeKey = renderingComponentName;
                  if (!didWarnAboutUpdateInRenderForAnotherComponent.has(dedupeKey)) {
                    didWarnAboutUpdateInRenderForAnotherComponent.add(dedupeKey);
                    var setStateComponentName = getComponentName2(fiber.type) || "Unknown";
        ...
        function warnIfNotCurrentlyActingEffectsInDEV(fiber) {
          {
            if ((fiber.mode & StrictMode) !== NoMode && IsSomeRendererActing.current === false && IsThisRendererActing.current === false) {
              error("An update to %s ran an effect, but was not wrapped in act(...).\n\nWhen testing, code that causes React state updates should be wrapped into act(...):\n\nact(() => {\n  /* fire events that update state */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://fb.me/react-wrap-tests-with-act%s", getComponentName2(fiber.type), getStackByFiberInDevAndProd(fiber));
            }
          }
        }
...
For more info, visit https://fb.me/react-mock-scheduler`);
              ...
              switch (type) {
                ...
                default: {
                  ...
                  var info = "";
                  {
                    ...
                    var ownerName = owner ? getComponentName2(owner.type) : null;
                    if (ownerName) {
                      info += "\n\nCheck the render method of `" + ownerName + "`.";
                    }
                  }
        ...
        function findHostInstanceWithWarning(component, methodName) {
          {
            ...
            if (hostFiber.mode & StrictMode) {
              var componentName = getComponentName2(fiber.type) || "Component";
        ...
        function updateContainer(element, container, parentComponent, callback) {
          ...
          }
          {
            if (isRendering && current !== null && !didWarnAboutNestedUpdates) {
              ...
              error("Render methods should be a pure function of props and state; triggering nested component updates from render is not allowed. If necessary, trigger nested updates in componentDidUpdate.\n\nCheck the render method of %s.", getComponentName2(current.type) || "Unknown");
            }
          }
          var update = createUpdate(expirationTime, suspenseConfig);
          update.payload = {
        ...
        function findDOMNode(componentOrElement) {
          {
            ...
            if (owner !== null && owner.stateNode !== null) {
              ...
              if (!warnedAboutRefsInRender) {
                error("%s is accessing findDOMNode inside its render(). render() should be a pure function of props and state. It should never access something that requires stale data from the previous render, such as refs. Move this logic to componentDidMount and componentDidUpdate instead.", getComponentName2(owner.type) || "A component");
              }
  ...
  const shallowequal = __toModule(require_shallowequal());
  ...
  var isPlainObject = function(x) {
    return x !== null && typeof x === "object" && (x.toString ? x.toString() : Object.prototype.toString.call(x)) === "[object Object]" && !react_is.typeOf(x);
  };
  ...
  function createStylisInstance(_temp) {
    ...
    var stylis2 = new stylis_browser_esm_default(options);
    var parsingRules = [];
    ...
    stylis2.use([].concat(plugins, [selfReferenceReplacementPlugin, parseRulesPlugin, returnRulesPlugin]));
    function stringifyRules(css2, selector, prefix, componentId) {
      ...
      return stylis2(prefix || !selector ? "" : selector, cssStr);
    }
  ...
  var StyleSheetContext = react.default.createContext();
  var StyleSheetConsumer = StyleSheetContext.Consumer;
  var StylisContext = react.default.createContext();
  ...
  function constructWithOptions(componentConstructor, tag, options) {
    ...
    if (!react_is.isValidElementType(tag)) {
  ...
  var ComponentStyle = /* @__PURE__ */ function() {
    ...
    _proto.generateAndInjectStyles = function generateAndInjectStyles(executionContext, styleSheet, stylis2) {
      var componentId = this.componentId;
      if (this.isStatic && !stylis2.hash) {
        ...
        if (!styleSheet.hasNameForId(componentId, name)) {
          var cssStaticFormatted = stylis2(cssStatic, "." + name, void 0, componentId);
        ...
        var dynamicHash = phash(this.baseHash, stylis2.hash);
        var css2 = "";
        ...
        if (!styleSheet.hasNameForId(componentId, _name)) {
          var cssFormatted = stylis2(css2, "." + _name, void 0, componentId);
  ...
  var ThemeContext = react.default.createContext();
  ...
  function useInjectedStyle(componentStyle, hasAttrs, resolvedAttrs, warnTooManyClasses) {
    ...
    var stylis2 = useStylis();
    var isStatic = componentStyle.isStatic && !hasAttrs;
    var className = isStatic ? componentStyle.generateAndInjectStyles(EMPTY_OBJECT, styleSheet, stylis2) : componentStyle.generateAndInjectStyles(resolvedAttrs, styleSheet, stylis2);
  ...
  function createStyledComponent(target, options, rules) {
    ...
    WrappedStyledComponent = react.default.forwardRef(forwardRef);
    ...
    if (isCompositeComponent) {
      hoist_non_react_statics.default(WrappedStyledComponent, target, {
        attrs: true,
        componentStyle: true,
        displayName: true,
  ...
  const Container2 = styled_components_browser_esm_default.div``;
  function App() {
    return /* @__PURE__ */ react3.default.createElement(Container2, null, /* @__PURE__ */ react3.default.createElement(Header, null));
  }
  var App_default = App;
  ...
  react_dom.default.render(/* @__PURE__ */ react4.default.createElement(react4.default.StrictMode, null, /* @__PURE__ */ react4.default.createElement(App_default, null)), document.getElementById("root"));
})();
